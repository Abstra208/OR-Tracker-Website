...
const nextConfig: NextConfig = {
  env: {
    ...
    REACT_DISCORD_CLIENT_ID: process.env.REACT_DISCORD_CLIENT_ID,
    REACT_DISCORD_CLIENT_SECRET: process.env.REACT_DISCORD_CLIENT_SECRET,
    REACT_DISCORD_REDIRECT_URI: process.env.REACT_DISCORD_REDIRECT_URI,
  },
};
